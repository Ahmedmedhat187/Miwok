...
public class PhrasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phrasesAdapter = new WordAdapter(this , phrases , R.color.category_phrases );
        listPhrases = (ListView) findViewById(R.id.list);
        ...
        listPhrases.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if(result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED){
                    ...
                    mediaPlayer = MediaPlayer.create(PhrasesActivity.this, phrasesObject.getSound());
                    mediaPlayer.start();
